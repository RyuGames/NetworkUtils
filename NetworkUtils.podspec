...
Pod::Spec.new do |s|
  s.name             = 'NetworkUtils'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NetworkUtils.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/WyattMufson/NetworkUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'WyattMufson' => 'wyatt@ryucoin.com' }
  s.source           = { :git => 'https://github.com/WyattMufson/NetworkUtils.git', :tag => s.version.to_s }
